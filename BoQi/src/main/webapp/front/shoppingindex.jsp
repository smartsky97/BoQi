	       ...
	       <div class="dogThing bigTop">
	           ...
	           <div class="dogShow">
	               ...
	               <div class="dog_r left rr">
	               	<div class="dog_r_up">
	                   	<div class="dog_r_show1" id="1001" style="display:block;" name='狗粮'>

		                   	<%-- <c:forEach items="${Top8 }" var="item">
			                	<c:if test="${item.suitpet eq '狗' && item.fid eq '1001'}">
			                	<dl class="dog_r_shopping1 left">
		                               <dt><a class='thing_pic' target='_blank' href="../productServlet?op=openThePro&pid=${item.proid}"><img src="../${item.firstPic }" alt="商品图片"></a></dt>
		                               
		                               <dd><a class='thing_name' target='_blank' href="../productServlet?op=openThePro&pid=${item.proid}">${item.proname}</a></dd>
		                               <dd>
		                                   <span class="thing_pri left">¥ ${item.bqpri }</span>
		                                   <span class=" thing_num right">已售${item.prosales }</span>
		                               </dd>
		                           </dl>
			            		</c:if>
		           			</c:forEach> --%>
	                       ...
	                       <div class="dog_r_show1" id="1002" style="display:none;" name='湿粮'>
		                        
	                       </div>
	                       
	                       <div class="dog_r_show1" id="1003" style="display:none;" name='零食'>
	                           
	                       </div>
	                       
	                       <div class="dog_r_show1" id="1004" style="display:none;" name='保健品'>
	                           
	                       </div>
	                       
	                       <div class="dog_r_show1" id="1005" style="display:none;" name='医疗'>
	                       	
	                       </div>
	                       
	                       <div class="dog_r_show1" id="1006" style="display:none;" name='沐浴露'>
	                       	
	                       </div>
	                       
	                       <div class="dog_r_show1" id="1007" style="display:none;" name='日用品'>
	                       	
	                       </div>
	                       
	                       <div class="dog_r_show1" id="1008" style="display:none;" name='美容'>
	                       	
	                       </div>
	                       
	                       <div class="dog_r_show1" id="1009" style="display:none;" name='玩具'>
	                       
	                       </div>
	                       
	                       <div class="dog_r_show1" id="1010" style="display:none;" name='衣服窝'>
