...
import com.yc.boqi.service.IUserInfoDao;
import com.yc.boqi.entity.UserInfo;
import com.yc.boqi.service.impl.UserInfoDaoImpl;

public class UserInfoDaoImpl implements IUserInfoDao {
	DBHelper db=new DBHelper();
	
	public UserInfo login(UserInfo user) {
		String sql="select * from bquserinfo where (email=? or uname=? or tel=?) and registerpwd=?";
		List<Object> params=new ArrayList<Object>();
		params.add(user.getUname());
		params.add(user.getUname());
		params.add(user.getUname());
		params.add(user.getRegisterpwd());
		List<UserInfo> result=db.find(sql, params, UserInfo.class);
